...
export const getHorseStatisticsEntriesDetail = (data) => {
  return get({
    url: SERVICE_TYPES.HORSE_STATISTICS_ENTRIES_DETAIL,
    ...data
  })
}
...
export const performLandingPage = (data, token) => {
  return post({
    url: SERVICE_TYPES.CONTACT,
    headers: {
...
export const updateUserVerification = (data) => {
  return post({
    url: SERVICE_TYPES.ACCOUNT_VERIFICATION_SETTING,
  })
}

export const searchTimeformHorseName = (data) => {
  return post({
    url: SERVICE_TYPES.HORSE_INFORMATION_EDITOR,
    ...data
  })
...
export const createSyndicate = (data) => {
  return post({
    url: SERVICE_TYPES.REGISTER_SYNDICATE,
    ...data
  })
}

export const manageSyndicateNewHorse = (data) => {
  return post({
    url: SERVICE_TYPES.SYNDICATE_SLUG_HORSE,
    ...data
  })
}

export const getSyndicateHorses = (data) => {
  return get({
    url: SERVICE_TYPES.SYNDICATE_SLUG_HORSE,
    ...data
  })
...
export const getSyndicateMembers = (data) => {
  return get({
    url: SERVICE_TYPES.SYNDICATE_SLUG_MEMBERS,
    ...data
  })
}


export const addSyndicateMember = (data) => {
  return post({
    url: SERVICE_TYPES.SYNDICATE_SLUG_MEMBERS,
    ...data
  })
...
export const messageSyndicateMembers = (data, token, slug) => {
  return post({
    url: SERVICE_TYPES.SYNDICATE_SLUG_MESSAGE,
    ...data
  })
}
