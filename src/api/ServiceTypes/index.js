...
export const SYNDICATE_MESSAGES = `${BASE_URL}/syndicate`
...
export const HORSE_STATISTICS_ENTRIES_DETAIL = `${HORSE_SLUG}/entries/:meetingDate`
...
export const SYNDICATE_SLUG_HORSE = `${SYNDICATE_SLUG}/horse`

export const SYNDICATE_SLUG_MEMBERS = `${SYNDICATE_SLUG}/members`

export const SYNDICATE_SLUG_MESSAGE = `${SYNDICATE_SLUG}/message`
...
export const REGISTER_SYNDICATE = `${BASE_URL}/syndicate/register`
...
export const GET_SYNDICATE_MEMBERS = `${BASE_URL}/syndicate`
...
export const ACCOUNT_VERIFICATION_SETTING = `${USER}/contego-verify`
